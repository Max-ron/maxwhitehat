...
"""
passgen: single-file banner + wordlist generator (Termux-friendly)
Rebranded by Max - Educational purposes only

UI polish:
- Colored banner (brand "max", Telegram "maxtools")
...
def run_wizard():
    ...
    if RICH_OK:
        console.print("[bold]=== passgen • Wordlist Generator ===[/]\n")
